export const accordionData = [
    ...
    id: 1,
    title: "Expérience",
    content: `Après plus de 30 années dans l'industrie en tant que technicien de production, de recherche et développement, dans la métalurgie, la chimie et la plasturgie, qui m'ont permis d’acquérir de très bonnes compétences telles que l’organisation, l’écoute et l'apprentissage en continu de nouvelle technologie.
