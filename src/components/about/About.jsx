  ...
  return (
    <>
      ...
      <section className="aboutSection">
        <p>
          Après plus de 30 années dans l'industrie en tant que technicien de production, de recherche et développement, qui m'ont permis d’acquérir de très bonnes compétences telles que l’organisation, l’écoute et l'apprentissage en continu de nouvelle technologie.
